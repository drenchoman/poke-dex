...
const dom = (() => {
  ...
  const addStartScreen = () => {
    ...
    let yellowDiv = createDiv('yellow-div')
    let blueDiv = createDiv('blue-div')
    let greenDiv = createDiv('green-div')
    let purpleDiv = createDiv('purple-div')
    let blackDiv = createDiv('black-div')
    let patternDiv = createDiv('pattern-div')
    ...
    div.append(yellowDiv, blueDiv, greenDiv, purpleDiv, blackDiv, patternDiv)
    app.appendChild(div)
